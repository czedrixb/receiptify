  ...
  >
    ...
    >
      <div class="text-center">
        ...
        <button
          @click="login"
          class="rounded-full bg-spotifyGreen flex items-center gap-3 font-bold px-5 py-6 mx-auto hover:bg-spotifyDarkGreen transition-colors duration-300 ease-in-out"
        >
          <svg
